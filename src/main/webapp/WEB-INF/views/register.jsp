...
<title>Student Ingestion - Student Management System</title>
...
<div class="app-container">
    ...
    <div class="form-card">
        <div class="form-header">
            <h2>Initialize Student Record</h2>
            <p>Create a raw master record inside the institutional catalog with required profile metadata attributes.</p>
        </div>
        ...
        <form action="save" method="POST">
            <div class="form-body">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="age" name="age" placeholder="Enter age" min="1" max="150" required>
                    </div>
            ...
            <div class="form-footer-action">
                <a href="/" class="action-btn btn-outline">Cancel Ingestion</a>
                <input type="submit" class="action-btn btn-solid" value="Register Student">
            </div>
        </form>
    </div>
